...
class ShapeScale {
  ...
  static const double none = ShapeTokens.cornerNone;
  static const double extraSmall = ShapeTokens.cornerExtraSmall;
  static const double small = ShapeTokens.cornerSmall;
  static const double medium = ShapeTokens.cornerMedium;
  static const double large = ShapeTokens.cornerLarge;
  static const double largeIncreased = ShapeTokens.cornerLargeIncreased;
  static const double extraLarge = ShapeTokens.cornerExtraLarge;
  static const double extraLargeIncreased =
      ShapeTokens.cornerExtraLargeIncreased;
  static const double extraExtraLarge = ShapeTokens.cornerExtraExtraLarge;
